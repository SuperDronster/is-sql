...
-- Item Names
select core.new_tag(8,NULL, 'shell','Shell');
select core.new_tag(8,NULL, 'fiber-count','Fiber Count');
...
--select new_spec_item(1,3000, NULL, 'shell', NULL);
--select new_spec_item(2,3000, 1, 'fiber-count', 2000);

--select spec.spec_item(3000,'shell/fiber-count');
